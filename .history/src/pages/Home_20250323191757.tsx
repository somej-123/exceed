        ...
        <Container>
          <Row className="align-items-center">
            ...
            <Col md={6} className="text-center">
              <FaRocket size={200} style={{ opacity: '0.9' }} />
            </Col>
          </Row>
        </Container>
      </div>
      ...
      <Container className="py-5">
        ...
        <Row>
          <Col md={4} className="mb-4">
            <Card className="h-100 shadow-sm hover-card">
              <div className="text-center pt-4">
                <FaBullhorn size={80} className="text-primary" />
              </div>
              <Card.Body>
          ...
          <Col md={4} className="mb-4">
            <Card className="h-100 shadow-sm hover-card">
              <div className="text-center pt-4">
                <BsGear size={80} className="text-primary" />
              </div>
              <Card.Body>
          ...
          <Col md={4} className="mb-4">
            <Card className="h-100 shadow-sm hover-card">
              <div className="text-center pt-4">
                <BsBook size={80} className="text-primary" />
              </div>
              <Card.Body>
