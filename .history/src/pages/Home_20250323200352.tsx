        ...
        <Container>
          <Row className="align-items-center">
            <Col md={6} className="mb-md-0">
              <h1 className="display-4 fw-bold ms-md-5">환영합니다</h1>
              <p className="lead mb-4 ms-md-5">Exceed와 함께 새로운 경험을 시작하세요.</p>
              <Button variant="light" size="lg" className="me-3 ms-md-5">시작하기</Button>
              <Button variant="outline-light" size="lg" className="ms-md-2">더 알아보기</Button>
            </Col>
